        ...
        *************************************************************************************************/
         ...
         function calculatePercentages() {
                  ...
                  *******************************************************************************************************/  
                  ...
                  document.getElementById("householdPercentage").innerHTML = "% for <b>food:</b>      " + householdPct.toFixed(1);
                  document.getElementById("miscellaneousPercentage").innerHTML = "% for <b>food:</b>      " + miscellaneousPct.toFixed(1);
                  document.getElementById("transportationPercentage").innerHTML = "% for <b>food:</b>      " + transportationPct.toFixed(1);
